...
L_8003A130:
    ...
    ctx->r7 = 0 | 0X8;
    // lh          $a1, 0x1A($s1)
    ctx->r5 = MEM_HS(0X1A, ctx->r17);
    // lh          $a2, 0x36($s1)
    ctx->r6 = MEM_HS(0X36, ctx->r17);
    // ori         $v0, $zero, 0x4
    ctx->r2 = 0 | 0X4;
    // jal         0x80014ED4
    // sw          $v0, 0x10($sp)
...
L_8003AB10:
    ...
    MEM_W(0X10, ctx->r29) = ctx->r2;
    // lb          $v0, 0x36($s1)
    ctx->r2 = MEM_BS(0X36, ctx->r17);
    // nop

    // sw          $v0, 0x14($sp)
    MEM_W(0X14, ctx->r29) = ctx->r2;
    // lb          $v0, 0x37($s1)
    ctx->r2 = MEM_BS(0X37, ctx->r17);
    // nop

    // sw          $v0, 0x18($sp)
    MEM_W(0X18, ctx->r29) = ctx->r2;
    // lb          $v0, 0x38($s1)
    ctx->r2 = MEM_BS(0X38, ctx->r17);
    // jal         0x800166F8
    // sw          $v0, 0x1C($sp)
