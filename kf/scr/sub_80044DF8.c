...
L_80044E5C:
    // lh          $v1, 0x34($a2)
    ctx->r3 = MEM_HS(0X34, ctx->r6);
    // lw          $v0, 0x14($a2)
    ctx->r2 = MEM_W(0X14, ctx->r6);
    // lh          $a0, 0x36($a2)
    ctx->r4 = MEM_HS(0X36, ctx->r6);
    // lh          $a1, 0x38($a2)
    ctx->r5 = MEM_HS(0X38, ctx->r6);
    // subu        $v0, $v0, $v1
    ctx->r2 = SUB32(ctx->r2, ctx->r3);
    // sw          $v0, 0x14($a2)
    MEM_W(0X14, ctx->r6) = ctx->r2;
