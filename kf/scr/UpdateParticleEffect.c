...
L_80045888:
    // lh          $a0, 0x32($s2)
    ctx->r4 = MEM_HS(0X32, ctx->r18);
    // lh          $a2, 0x42($s2)
    ctx->r6 = MEM_HS(0X42, ctx->r18);
    // jal         0x80015D18
    // addu        $a1, $zero, $zero
    ctx->r5 = ADD32(0, 0);
...
L_800470E4:
    ...
    ctx->r7 = 0 | 0X3C;
    // lh          $v1, 0x34($s2)
    ctx->r3 = MEM_HS(0X34, ctx->r18);
    // lw          $v0, 0x14($s2)
    ctx->r2 = MEM_W(0X14, ctx->r18);
    // lh          $t0, 0x36($s2)
    ctx->r8 = MEM_HS(0X36, ctx->r18);
    // lh          $t1, 0x38($s2)
    ctx->r9 = MEM_HS(0X38, ctx->r18);
    // subu        $v0, $v0, $v1
    ctx->r2 = SUB32(ctx->r2, ctx->r3);
    // sw          $v0, 0x14($s2)
    MEM_W(0X14, ctx->r18) = ctx->r2;
...
L_80047438:
    ...
    ctx->r5 = ADD32(0, 0);
    // lh          $a0, 0x36($s2)
    ctx->r4 = MEM_HS(0X36, ctx->r18);
    // lh          $a2, 0x30($s2)
    ctx->r6 = MEM_HS(0X30, ctx->r18);
    // lw          $v1, 0x1C($s3)
    ctx->r3 = MEM_W(0X1C, ctx->r19);
    // mflo        $v0
    ctx->r2 = lo;
...
L_8004779C:
    ...
    ctx->r7 = 0 | 0X61A8;
    // lh          $a1, 0x26($s2)
    ctx->r5 = MEM_HS(0X26, ctx->r18);
    // lh          $a2, 0x24($s2)
    ctx->r6 = MEM_HS(0X24, ctx->r18);
    // ori         $v0, $zero, 0x320
    ctx->r2 = 0 | 0X320;
    // sw          $v0, 0x10($sp)
    MEM_W(0X10, ctx->r29) = ctx->r2;
