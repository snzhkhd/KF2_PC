...
L_80016DAC:
    ...
    // lb          $a1, 0x79ED($a1)
    ctx->r5 = MEM_BS(0X79ED, ctx->r5);
    // lui         $a2, 0x8017
    ctx->r6 = S32(0X8017 << 16);
    // lb          $a2, 0x79EC($a2)
    ctx->r6 = MEM_BS(0X79EC, ctx->r6);
    // ori         $v0, $zero, 0x1
    ctx->r2 = 0 | 0X1;
    // lui         $at, 0x8017
    ctx->r1 = S32(0X8017 << 16);
